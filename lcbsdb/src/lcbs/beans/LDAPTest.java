...
public class LDAPTest {
     ...
     */
    public static void testLdap() throws NamingException {
        
        final String ldapAdServer = "ldap://127.0.0.1:389";
        final String ldapSearchBase = "dc=ldap,dc=lacbus,dc=com";
        
        final String ldapUsername = "admin";
        final String ldapPassword = "p455w0rd";
        
        final String ldapAccountToLookup = "dlevy";
        ...
        log.info("################################newEM#################################### "+primaryGroupName +" "+primaryGroupSID);
    }
