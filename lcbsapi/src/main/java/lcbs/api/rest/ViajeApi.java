...
public class ViajeApi extends BaseApi {
	...
	public List<DataTerminal> getTerminales(@PathParam("pagina") final Integer pagina,
	...
	public List<DataPasajeConvertor> obtenerTotalPasajesVendidos(@PathParam("fecha") final String fecha,
	...
	public List<DataViajeConvertor> viajesPorTerminal(@PathParam("idterminal") String idterminal,
			@PathParam("pagina") final Integer pagina, @PathParam("elementosAMostrar") final Integer ElementosPagina) {
	...
	public List<DataParada> getParadas(@PathParam("pagina") final Integer pagina,
			@PathParam("elementosAMostrar") final Integer elementosPagina) {
		DataTenant tenant = (DataTenant) request.getAttribute("tenant");
	...
	public List<DataViajeConvertor> BuscarViaje(DataViaje filtro, @PathParam("pagina") final Integer pagina,
	...
	public List<DataRecorrido> BuscarRecorrido(DataRecorrido filtro, @PathParam("pagina") final Integer pagina,
	...
	public List<DataRecorrido> listarRecorridos(@PathParam("pagina") final Integer pagina,
			@PathParam("elementosAMostrar") final Integer elementosPagina) {
		DataTenant tenant = (DataTenant) request.getAttribute("tenant");
	...
	public List<DataPasajeConvertor> obtenerHistorialPasajes(@PathParam("idUsuario") final String idUsuario,
			@PathParam("pagina") final Integer pagina, @PathParam("elementosAMostrar") final Integer elementosPagina) {
		DataTenant tenant = (DataTenant) request.getAttribute("tenant");
	...
	public List<DataViaje> getViajes(@PathParam("pagina") final Integer pagina,
			@PathParam("elementosAMostrar") final Integer elementosPagina) {
		DataTenant tenant = (DataTenant) request.getAttribute("tenant");
	...
	public List<DataPasajeConvertor> getPasajes(@PathParam("pagina") final Integer pagina,
			@PathParam("elementosAMostrar") final Integer ElementosPagina) {
		DataTenant tenant = (DataTenant) request.getAttribute("tenant");
	...
	public Float getPrecioDePasaje(@PathParam("codigoOrigen") final String codigoOrigen,
	...
	public Integer cantidadAsientosDisponibles(@PathParam("idViaje") final String idViaje,
